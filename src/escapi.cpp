//# Demo Web can with images filter
...
int setupESCAPI()
{
  ...
  //  if (capdll == NULL)
    ...
    HMODULE capdll = LoadLibraryA("C:\\Users\\ansor\\source\\repos\\Pavic_Web_Camera_Image_Processing\\Pavic_WebCamera_Image_Processing\\escapi3\\bin\\Win32\\escapi.dll");
    if (capdll == NULL)
        return 0;
